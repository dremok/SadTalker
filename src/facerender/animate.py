...
from src.utils.videoio import save_video
...
class AnimateFromCoeff():
    ...
    def generate(self, x, video_save_dir, pic_path, crop_info, enhancer=None, background_enhancer=None,
        ...
        save_video(path, new_audio_path, av_path)
        output_path = f"{video_save_dir}/{video_name}"
        print(f'The generated video is named {output_path}')
        ...
        if enhancer:
            ...
            save_video(enhanced_path, new_audio_path, av_path_enhancer)
