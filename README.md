...
<b>TODO: Create web app that takes text input and creates avatar on the fly. Shows idle avatar. 
Outputs time for each step. Plays avatar in app, then goes back to idle.</b> 
